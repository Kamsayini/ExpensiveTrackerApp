...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 252, 251, 226),
      //
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(255, 2, 85, 117),
        child: Icon(
          Icons.add_outlined,
          size: 32.0,
        ),
              ...
              children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                colors: <Color>[
                                  Color.fromARGB(137, 2, 76, 178),
                                  Color.fromRGBO(1, 13, 35, 1),
                                ],
                              ),
                            ),
                            child: CircleAvatar(
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: const Color.fromARGB(228, 11, 3, 76),
                              ),
                              maxLines: 1,
                            ),
                          ),
                ...
                dataSet.isEmpty || dataSet.length < 2
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                          color: Color.fromARGB(255, 209, 216, 232),
                    ...
                    Row(
                      children: [
                        Icon(
                          ...
                          size: 28.0,
                          color: const Color.fromARGB(255, 215, 148, 148),
                        ),
                        SizedBox(
                          width: 4.0,
                        ),
